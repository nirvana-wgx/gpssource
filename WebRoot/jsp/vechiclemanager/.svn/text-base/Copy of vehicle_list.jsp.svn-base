			...
			<form method="post" id="queryform" action="list.page">
				<table cellspacing="0">
					...
					<tr>
						...
						<td class="right">
							<input type="text" name="ownername" value="${car.ownername}"/>
						</td>
						<td >
							车辆编号
						</td>
						<td class="right">
							<input type="text" name="vehicleid" value="${car.vehicleid}"/>
						</td>
						<td >
							设备编号
						</td>
						<td class="right">
							<input type="text" name="deviceid" value="${car.deviceid}"/>
						</td>
						<td >
							SIM卡号
						</td>
						<td class="right">
							<input type="text" name="sim" value="${car.sim}"/>
						</td>
					</tr>
					<tr>
						<td colspan="99" class="right">
						    <span><input name="vehicleidlockstate" type="checkbox" value="1" />被锁定</span>
							<span><input name="nowork" type="checkbox" value="1" />长时间不工作(10天未接收)</span>
							<span><input name="gpsstate" type="checkbox" value="1" />定位异常(10天未定位)</span>
						</td>
					</tr>
					<tr>
