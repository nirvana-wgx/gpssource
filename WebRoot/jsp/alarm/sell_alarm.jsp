...
<html>
   ...
   <body>  
      <br/>  
      <div>
         <form id="serform" action="<%=path%>/jsp/alarm/SellAlarm.page"  method="post">
            <table style="border-collapse:collapse;border-spacing:0;">
               ...
               <tr>
                  <td style="text-align:right;">报警时间</td>
                  <td>
                     <input class="Wdate" type="text" id="serdate" name="serdate" value="${ serdate }" onFocus="WdatePicker({isShowClear:false,readOnly:true})"/>
                  </td>
                     ...
                     <div id="div_list">
                        <table id="tab_list">
                           <tr>
                              ...
                              <th scope="col" abbr="报警项目">累计报警月份</th>
                              <th scope="col" abbr="报警项目">累计报警金额</th>
                           </tr>
                           
                           <c:if test="${fn:length(sellalarmlist)==0}">
                              <tr><td align='center' colspan='10'><font color='red'>无记录</font></td></tr>
                           </c:if>
                           
                           <c:forEach items="${sellalarmlist}" var="sellalarm" varStatus="status">
                              <tr>
                                 <td>
                                    ${ sellalarm.vehicleid }
                                 </td>
                                 ...
                                 <td>
                                    <fmt:formatNumber value="${ sellalarm.totamt }" pattern="#,#00.00#"/>
                                 </td>
                              </tr>
                           </c:forEach>
                        </table>
...
function gotofirst() {
   ...
   window.location.href = "<%=path%>/jsp/alarm/SellAlarm.page?servehicleid=" + servehicleid + "&seraccount=" + seraccount + "&serdate=" + serdate + "&page_no=" + page_no + "&page_num=" + page_num;
}
...
function reset() {
   ...
   document.getElementById("serdate").value = "";
}
